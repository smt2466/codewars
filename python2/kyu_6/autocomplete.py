...
def autocomplete(input_, dictionary):
    ...
    Args:
        input_ (str): Start of completion
        dictionary (list): List of strings of possible completions

    Returns:
        list: List of strings (<= 5) of possible completions to given input

    Examples:
        >>> autocomplete('a', ['ab', 'cd', 'ef', 'ag'])
        ['ab', 'ag']
    """
    input_ = filter(str.isalpha, input_)
