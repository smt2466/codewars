...
KEYBOARD = ['1', 'ABC2', 'DEF3', 'GHI4', 'JKL5', 'MNO6', 'PQRS7', 'TUV8',
            'WXYZ9', '*', ' 0', '#']


def presses(phrase):
    """Count number of taps needed to complete phrase with T9 keyboard

    Args:
        phrase (str): Sample text
